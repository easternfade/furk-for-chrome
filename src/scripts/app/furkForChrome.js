...
define(['underscore/underscore-min',
    'util/base32',
    'app/furkAPI',
    'app/furkForChromeNotifications',
    'app/furkForChromeStorage'], function (_, base32converter, furkAPI, notifications, storage) {
        ...
        var module = {
            ...
            parseApiResponse: function (e) {
                ...
                var xhr = module.processResponse(e);
                ...
                switch (xhr.status) {
                    ...
                    case 200:
                        ...
                        notificationMessage = notifications.buildSuccessNotification(xhr.responseJson);
                        break;
                }
            ...
            furkAPIResponse: function (e) {
                module.parseApiResponse(e.target);
            },
            download: function (e) {
                var xhr = module.processResponse(e.target);
            ...
            notificationHandler: function (notificationId, buttonIndex) {
                furkAPI.getFile(notificationId, module.download);
            },
                ...
                chrome.contextMenus.onClicked.addListener(function (info, tab) {
                    switch (info.menuItemId) {
                        case "ffc_context_main":
                            furkAPI.addToFurk(module.parseUrl(info), module.furkAPIResponse);
                            break;
                    }
                });
